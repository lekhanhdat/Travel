...
export const LOCATION_POPULAR: ILocation[] = [
  ...
  },
  {
    ...
    description: 'Đưa vào hoạt động năm 2013, với thiết kế độc đáo mang hình dáng con rồng bắc qua sông Hàn thơ mộng, điểm tham quan này là một trong những địa điểm du lịch mới hấp dẫn du khách hấp dẫn du khách .',
