...
> {
  ...
  componentDidMount(): void {
        ...
        BackgroundGeolocation.watchPosition(
          position => {
            ...
            (locationProps?.length > 0
              ...
              const mile = this.haversineDistance(
    ...
    const locationProps: ILocation[] =
      this.props.navigation.state?.params?.locations ?? [];
  ...
  fetchRoute = async () => {
    ...
    try {
      ...
      if (response.data.routes.length) {
        const points = this.decodePolyline(
  ...
  render(): React.ReactNode {
    ...
    return (
      <Page>
        {/* <HeaderBase
          hideLeftIcon={locationProps.length === 0}
          title={strings.map}
          leftIconSvg={
            locationProps.length > 0 && (
              <BackSvg
              ...
              {locationProps.length > 0 && (
                <Polyline
                  coordinates={[
                    ...
                    {
                      latitude: locationProps[0].lat,
                      longitude: locationProps[0].long,
                    },
                  ]}
                  strokeWidth={4}
                />
          ...
          <View
            ...
            <View
              ...
              <TextBase style={AppStyle.txt_14_regular}>
                - Bỏ rác vào thùng hoặc mang rác về sau khi tham quan tại Bán
                đảo Sơn Trà.
              </TextBase>
              <View style={{height: sizes._8sdp}} />

              <TextBase style={AppStyle.txt_14_regular}>
                - Không cho khỉ ăn bằng bất kỳ hình thức nào hoặc tiếp xúc gần
                với khỉ, điều này giúp bảo vệ đàn khỉ và tránh các nguy cơ gây
                hại cho con người, vì khỉ có thể tấn công hoặc lây nhiễm các
                bệnh do vi khuẩn và vi-rút sang con người.{' '}
              </TextBase>
              <View style={{height: sizes._8sdp}} />
